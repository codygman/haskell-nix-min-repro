...
in { system, compiler, flags, pkgs, hsPkgs, pkgconfPkgs, ... }:
  {
    ...
    src = (pkgs.lib).mkDefault (pkgs.fetchgit {
      url = "https://github.com/haskell-vanguard/network-bsd";
      rev = "9f372485748f8b29ce6e723eb838da6f55d4157f";
      sha256 = "0r8pg5v8wk1jv1gps77zwq1y22d9n48adccch77x1vdnwwzk712q";
      });
    }